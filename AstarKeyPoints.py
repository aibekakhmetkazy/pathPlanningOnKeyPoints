...
class Graph:
    ...
    def a_star_algorithm(self, start_node, stop_node, pointsAndCoordinates):
        ...
        while len(open_list) > 0:
            ...
            for v in open_list:
                # print(g[v], self.h(v, pointsAndCoordinates))
...
def adjacencyListCreation(pts, startx, starty, finalx, finaly):
    ...
    #             if dist < 30 and i not in obstacles and j not in obstacles:
    ...
    return adjacency_list, N, pointsAndCoordinates, obstaclesList

adjacency_list, N, pointsAndCoordinates, obstaclesList = (
    adjacencyListCreation(pts, 60, 60, 700, 700)) # pts and x,y of start and final points

graph1 = Graph(adjacency_list)
pathList = graph1.a_star_algorithm(N-1, N, pointsAndCoordinates) # N-1 and N are numbers of start and final points
...
cv2.imwrite('pathPlanningAstarWithObstacle1.jpg', newimg)
